...
public class ResepDokter {
    ...
    private boolean statusVerifikasi; // true jika disetujui, false jika belum diverifikasi
    ...
    public void tampilkanResep() {
        ...
        System.out.println("Status Verifikasi: " + (statusVerifikasi ? "Disetujui" : "Belum Diverifikasi"));
        System.out.println("---------------------------------");
    }
}
