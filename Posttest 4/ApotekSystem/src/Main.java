...
public class Main {
        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    tambahObat(adminService);  // Menambahkan obat setelah menu admin dipilih
                    break;
                case 2:
    ...
    // Menambahkan obat setelah menu admin dipilih, bukan di luar alur eksekusi
    private static void tambahObat(AdminService adminService) {
        adminService.tambahObat(2001, "Paracetamol Extra", 12000.0, 50, false);
        // Contoh Overriding: lihat daftar obat yang akan panggil toString()
        System.out.println("\nDaftar Obat setelah ditambahkan:");
        adminService.lihatObat();
    }
}
