...
public class Obat {
    ...
    public String toString() {
        return "Obat{" +
               ...
               ", Harga=" + harga +
               ", Stok=" + stok +
               ", Butuh Resep=" + (resepDokter ? "Ya" : "Tidak") +  // Ganti butuhResep dengan resepDokter
               '}';
    }
    

    public void tampilkanObat() {
        System.out.println(this);  // Menampilkan output menggunakan toString yang telah diperbaiki
    }
